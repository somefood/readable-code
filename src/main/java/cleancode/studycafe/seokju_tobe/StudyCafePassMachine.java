...
public class StudyCafePassMachine {
    ...
    public void run() {
        try {
            ...
            final StudyCafeLockerPass findLockerPass = findLockerPass(selectedPass);

            boolean lockerSelection = false;
            if (findLockerPass.canUse()) {
                outputHandler.askLockerPass(findLockerPass);
                lockerSelection = inputHandler.getLockerSelection();
            }

            if (lockerSelection) {
                outputHandler.showPassOrderSummary(selectedPass, findLockerPass);
            } else {
    ...
    private StudyCafeLockerPass findLockerPass(StudyCafePass selectedPass) {
        ...
        return lockerPasses.getStudyCafeLockerPass(selectedPass);
    }
}
